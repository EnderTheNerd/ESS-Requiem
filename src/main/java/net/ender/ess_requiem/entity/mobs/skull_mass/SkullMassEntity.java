...
public class SkullMassEntity  extends AbstractSpellCastingMob implements IMagicSummon, GeoAnimatable, IAnimatedAttacker {
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return LivingEntity.createLivingAttributes()
                ...
                .add(AttributeRegistry.BLOOD_SPELL_POWER, .9)
    ...
    //I HATE GECKOLIB
    private final AnimationController<SkullMassEntity> animationController = new AnimationController<>(this, "controller", 0, this::predicate);
    ...
    private PlayState predicate(AnimationState<SkullMassEntity> event)
    {
