...
public class SwiftDemise extends MagicSwordItem {
    ...
    public @NotNull InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand usedHand) {
        ...
        if (mainhandItem.getItem() instanceof SwiftDemise && offhandItem.getItem() instanceof SkyfallsCause) {
            ...
            } else if (!player.isCrouching() && player.getMainHandItem().is(GGItemRegistry.SWIFT_DEMISE)&& offhandItem.getItem() instanceof SkyfallsCause) {
