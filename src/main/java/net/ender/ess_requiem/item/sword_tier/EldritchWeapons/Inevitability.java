...
public class Inevitability extends MagicSwordItem {
    ...
    public Inevitability() {
        super(GGSwordTier.INEVITABILITY,  new Item.Properties().rarity(ASRarities.COSMIC_RARITY_PROXY.getValue()).attributes(ExtendedSwordItem.createAttributes(GGSwordTier.INEVITABILITY)),
