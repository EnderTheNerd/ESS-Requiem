...
import net.ender.ess_requiem.entity.armor.CrimsonKingArmorModel;
...
public class CrimsonKingArmorItem extends ImbuableChestplateArmorItem {
    ...
    public CrimsonKingArmorItem(Type type, Properties settings) {
        super(ArmorMaterialRegistry.SCHOOL, type, settings,
                ...
                new AttributeContainer(AttributeRegistry.BLOOD_SPELL_POWER, 0.12, AttributeModifier.Operation.ADD_MULTIPLIED_BASE)
    ...
    public GeoArmorRenderer<?> supplyRenderer() {
        return new GenericCustomArmorRenderer<>(new CrimsonKingArmorModel());
    }
