...
public class ArmOfDecayWeakRaise extends AbstractSpell {

        private final ResourceLocation spellId = ResourceLocation.fromNamespaceAndPath(EndersSpellsAndStuffRequiem.MOD_ID, "arm_of_decay_insta_raise_weak");
